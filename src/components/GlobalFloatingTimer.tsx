...
export const GlobalFloatingTimer = () => {
  const { timerState, onPause, onResume, onReset, onContinue, showFloatingTimer } = useTimer();
    ...
    <AnimatePresence>
      ...
      >
        {timerState.showActivityCheck ? (
          ...
          >
            <div className={`w-3 h-3 rounded-full ${timerState.isRunning ? "bg-success animate-pulse" : "bg-warning"}`} />
          ...
          <div className="glass-card p-4 min-w-[180px] shadow-[0_0_30px_hsl(var(--primary)_/_0.3)]">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  onClick={() => showFloatingTimer(false)}
                  className="p-1 hover:bg-muted rounded-md transition-colors"
                >
            ...
            <div className="text-center mb-3">
              <span className={`text-3xl font-bold font-mono ${timerState.isRunning ? "text-primary" : "text-muted-foreground"}`}>
            ...
            <div className={`mt-2 h-1 rounded-full overflow-hidden bg-muted`}>
              <motion.div
                ...
                animate={{ width: timerState.isRunning ? "100%" : "0%" }}
  ...
  // Use portal to render at body level so it persists across routes
